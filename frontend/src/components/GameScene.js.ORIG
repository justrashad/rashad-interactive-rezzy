...
const GameScene = ({ currentLevel, characterPosition, isMoving, worldPosition, gameState, onLevelChange }) => {
  ...
  switch (currentLevel) {
    case 0: // Introduction - Clean Hills & Sky
      return (
        <>
          {/* Pixel Clouds */}
          ...
          <div className="pixel-hill pixel-hill-3"></div>
        </>
      );
    
    case 1: // About - Peaceful Sunrise
      return (
        <>
          {/* Sun */}
    ...
    case 2: // Basketball - Indoor Court
      return (
        <>
          {/* Stadium Lights */}
        ...
        <div className="world-content" style={{ width: '21000px', position: 'relative' }}>
          ...
          <div className="world-section basketball-section" style={{ left: '6000px', width: '3000px' }}>
            ...
            <div className="basketball-stadium">
              ...
              {/* ENHANCED Houston Skyline Background */}
              <div className="houston-skyline-enhanced">
                {/* Main iconic buildings */}
                <div className="houston-building-enhanced jpmorgan-chase">
                  <div className="building-top chase-top"></div>
                  <div className="building-windows"></div>
                </div>
              <div className="houston-building-enhanced williams-tower">
                <div className="building-top williams-top"></div>
                <div className="building-windows"></div>
              </div>
              <div className="houston-building-enhanced heritage-plaza">
                <div className="building-top heritage-top"></div>
                <div className="building-windows"></div>
              </div>
              <div className="houston-building-enhanced wells-fargo">
                <div className="building-top wells-top"></div>
                <div className="building-windows"></div>
              </div>
              <div className="houston-building-enhanced centerpoint">
                <div className="building-top centerpoint-top"></div>
                <div className="building-windows"></div>
              </div>
  
              {/* Additional backdrop buildings */}
              <div className="houston-building-small hb-small-1"></div>
              <div className="houston-building-small hb-small-2"></div>
              <div className="houston-building-small hb-small-3"></div>
              <div className="houston-building-small hb-small-4"></div>
  
              {/* City atmosphere - heat haze effect */}
